...
fn is_svgz_from_svg() {
    assert!(!is_svg::is_svgz(include_str!("data/resvg/image-033.svg")));
...
fn is_svgz_from_svgz() {
    assert!(is_svg::is_svgz(include_bytes!("data/resvg/image.svgz")));
}
...
fn is_svgz_from_non_svg() {
    assert!(!is_svg::is_svgz(include_str!("data/resvg/green.css")));
    assert!(!is_svg::is_svgz(include_bytes!(
        "data/resvg/image-63x61.png"
    )));
    assert!(!is_svg::is_svgz(include_bytes!("data/resvg/image.gif")));
    assert!(!is_svg::is_svgz(include_bytes!("data/resvg/image.jpg")));
    assert!(!is_svg::is_svgz(include_bytes!("data/resvg/image.png")));
}
...
fn is_svgz_from_html() {
    ...
    assert!(!is_svg::is_svgz(include_str!("data/resources/index.xhtml")));
}
